function semilogyz1(x,y1,y2,labelx,labely,legend1,legend2,pathname)
...
%%Plot
        figure;
        semilogy(x,y1,'-r',x,y2,'--b','LineWidth',2)
        xlabel(labelx,'FontSize',24)
        ylabel(labely,'FontSize',24);
        grid on
